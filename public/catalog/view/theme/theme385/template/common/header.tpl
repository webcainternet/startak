...
<div class="swipe">
	<div class="swipe-menu">
		<ul class="links">
			...
			<?php /* <li class="first"><a class="<?php echo $route; if (isset($this->request->get['route']) && $this->request->get['route']=="common/home") {echo "active";} ?>" href="<?php echo $home; ?>"><i class="fa fa-home"></i><?php echo $text_home; ?></a></li> */ ?>
			...
			<?php /* <li><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="checkout/cart") {echo "active";} ?>" href="<?php echo $shopping_cart; ?>"><i class="fa fa-shopping-cart"></i><?php echo $text_shopping_cart; ?></a></li> */ ?>
			<?php /* <li><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="checkout/checkout") {echo "active";} ?>" href="<?php echo $checkout; ?>"><i class="fa fa-check"></i><?php echo $text_checkout; ?></a></li> */ ?>
		</ul>
			...
			<div class="col-sm-12">
				<div id="menu">
					<ul  class="sf-menu">
						...
						<?php } ?>
						<li class="cat_6" style="border: 0px;background-color: #f79748; height: 48px; float: right; color: #FFFFFF;">
									<a href="/oferta-do-dia" style="font-size: 14px; color: #FFFFFF;">Oferta do dia</a>
								</li>
					</ul>
...
<div class="container">
<?php if (!empty($error)) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme385/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
